...
public class Menu {
	...
	public Menu(){
		...
		q = new Rectangle((int)((MainGame.xSize)/2-(150*MainGame.xScalingFactor)), (int) (430*MainGame.yScalingFactor), (int)(300*MainGame.xScalingFactor), (int)(150*MainGame.yScalingFactor));
